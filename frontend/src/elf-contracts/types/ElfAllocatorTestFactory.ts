...
import type { ElfAllocatorTest } from "./ElfAllocatorTest";

export class ElfAllocatorTestFactory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ElfAllocatorTest {
    return new Contract(address, _abi, signerOrProvider) as ElfAllocatorTest;
  }
}
