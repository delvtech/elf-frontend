...
interface BaseElfYVaultAssetInterface extends ethers.utils.Interface {
  functions: {
...
export class BaseElfYVaultAsset extends Contract {
  ...
  interface: BaseElfYVaultAssetInterface;
