...
import type { InternalBalance } from "../InternalBalance";

export class InternalBalance__factory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): InternalBalance {
    return new Contract(address, _abi, signerOrProvider) as InternalBalance;
  }
}
