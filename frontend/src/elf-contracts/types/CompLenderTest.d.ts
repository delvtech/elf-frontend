...
interface CompLenderTestInterface extends ethers.utils.Interface {
  functions: {
    ...
    "test_integration()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_integration",
    values?: undefined
  ): string;
...
export class CompLenderTest extends Contract {
  ...
  interface: CompLenderTestInterface;
  ...
  functions: {
    ...
    test_integration(overrides?: Overrides): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    test_integration(overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    test_integration(overrides?: Overrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    test_integration(overrides?: Overrides): Promise<PopulatedTransaction>;
