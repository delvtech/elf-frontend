...
interface TBPoolJoinExitNoFeeInterface extends ethers.utils.Interface {
  functions: {
    ...
    "joinAndExitNoFeePool(uint256,uint256,uint256,uint256)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "joinAndExitNoFeePool",
...
export class TBPoolJoinExitNoFee extends Contract {
  ...
  interface: TBPoolJoinExitNoFeeInterface;
