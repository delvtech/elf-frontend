...
interface FlashLoanProviderInterface extends ethers.utils.Interface {
  functions: {
...
export class FlashLoanProvider extends Contract {
  ...
  interface: FlashLoanProviderInterface;
