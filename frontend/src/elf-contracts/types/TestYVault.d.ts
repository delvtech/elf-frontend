...
export class TestYVault extends Contract {
  ...
  functions: {
    ...
    updateShares(overrides?: Overrides): Promise<ContractTransaction>;
  ...
  populateTransaction: {
    ...
    updateShares(overrides?: Overrides): Promise<PopulatedTransaction>;
