...
interface BaseElementYVaultAssetInterface extends ethers.utils.Interface {
  functions: {
...
export class BaseElementYVaultAsset extends Contract {
  ...
  interface: BaseElementYVaultAssetInterface;
