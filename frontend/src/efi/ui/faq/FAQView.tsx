    ...
    <div className={investViewClassName}>
      <div className={sectionClassName}>
        ...
        <p>
          ...
          There are many opportunites for investing in DeFi and the landscape can change very quickly.  It often
          ...
          automatically rebalance funds to keep collatorization ratios healthy.`}
        </p>
        <br />
      </div>
      <div className={sectionClassName}>
        ...
        <p>
          {t`Element Finance allows users access to a variety of investment strategies while maintaing the ownership
          of the asset they invest with.
          There are many opportunites for investing in DeFi and the landscape can change very quickly.  It often
          requires many steps to aquire the correct assets to invest in different strategies.  Our smart contracts
          accept a few basic staking assets and handle the rest of the transactions.  We invest through several
          pools, delegated vaults and automated money markets, (AMMs) to find the best returns.  On top of that, we
        ...
        <p>
          ...
          our protocols be goverenend by a decentralized autonomous organization (DAO).  This means that anyone who uses the
      ...
      <div className={sectionClassName}>
        ...
        <p>
          {t`As with any investment, there are always inherint risks.  DeFi is quickly evolving and the assets can be volitile
