...
export const stubbedMarkets: Market[] = [
  {
    ...
    assets: [
      { name: "Ether", symbol: "ETH", address: "0x1234", contract: undefined },
      {
        name: "Fixed Yield Ether",
        symbol: "fyETH",
        address: "0x1234",
        contract: undefined,
      },
  ...
  },
  {
    ...
    totalSupply: "123456789",
    assets: [
      { name: "USDC", symbol: "USDC", address: "0x1234", contract: undefined },
      {
        name: "Fixed Yield USDC",
        symbol: "fyUSDC",
        address: "0x1234",
        contract: undefined,
      },
