...
import { t } from "ttag";
import { StakingForm } from "elf-ui/pools/StakingForm/StakingForm";
...
interface StakeYieldTokenFormsProps {
...
export function StakeYieldTokensForm(
  props: StakeYieldTokenFormsProps
): ReactElement {
