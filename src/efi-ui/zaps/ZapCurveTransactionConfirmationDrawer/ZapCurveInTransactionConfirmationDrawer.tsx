...
interface ZapCurveInTransactionConfirmationDrawerProps {
...
export function ZapCurveInTransactionConfirmationDrawer({
  library,
  account,
  tokenInAsset,
  tokenInAddress,
  ...
  onClose,
  poolInfo,
}: ZapCurveInTransactionConfirmationDrawerProps): ReactElement {
